...
fetches the pinned version (`v7.48.01`) from the official releases and records its checksum.
...
`scripts/fetch_gam.sh`. The tested pin is currently **GAM 7.48.01**. The running app never downloads
